RocketMQ message queue cluster mainly includes four roles: NameServer, Broker (Master/Slave), Producer and Consumer. The
...
pool is, the wider the concurrent channel is required.
